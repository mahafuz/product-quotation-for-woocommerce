<div class="wrap">
	<h1 class="screen-reader-text">Product Quotation For WooCommerce Help Page</h1>

	<h1 class="pqfw-help-page-title" style="font-weight: bold">Help</h1>
	...
	<div class="pqfw-help-page">
		...
		<div class="help-block">
			<img src="<?php echo esc_url( PQFW_PLUGIN_URL . 'assets/images/bugs.svg' ); ?>" alt="Found Any Bugs?"> 
		...
		<div class="help-block">
			<img src="<?php echo esc_url( PQFW_PLUGIN_URL . 'assets/images/like.svg' ); ?>" alt="Like The Plugin?"> 
			<h3>Like The Plugin?</h3>
			<p>Your Review is very important to us as it helps us to grow more.</p>
			<a target="_blank" href="https://wordpress.org/support/plugin/product-quotation-for-woocommerce/reviews/#new-post" class="button button-primary">Review Us on WP.org</a>
		</div>
	</div>
</div>
