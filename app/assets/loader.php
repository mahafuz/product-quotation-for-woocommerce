...
class Loader extends Base {
	...
	public function frontend_scripts() {
		wp_enqueue_script(
			...
			QUOTIFY_PLUGIN_ASSETS_URI . sprintf( 'build/button.%s.js', QUOTIFY_PLUGIN_VERSION ),
			[ 'wp-util' ],
			QUOTIFY_PLUGIN_VERSION,
			true
		);

		wp_enqueue_script(
			'pqfw-quotation-cart',
			QUOTIFY_PLUGIN_ASSETS_URI . sprintf( 'build/cart.%s.js', QUOTIFY_PLUGIN_VERSION ),
			[ 'wp-util', 'jquery' ],
			QUOTIFY_PLUGIN_VERSION,
			true
		);
		...
		wp_enqueue_script(
			'pqfw-form',
			QUOTIFY_PLUGIN_ASSETS_URI . sprintf( 'build/form.%s.js', QUOTIFY_PLUGIN_VERSION ),
			[ 'jquery' ],
			QUOTIFY_PLUGIN_VERSION,
			true
		);
		...
		wp_localize_script(
			...
			[
				...
				'loader'        => QUOTIFY_PLUGIN_VERSION . 'assets/images/loader.gif',
