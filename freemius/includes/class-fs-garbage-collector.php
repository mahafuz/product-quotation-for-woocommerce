...
class FS_Product_Garbage_Collector implements FS_I_Garbage_Collector {
	...
	function clean() {
		$this->_gc_timestamp  = $this->_accounts->get_option( 'gc_timestamp', [] );
		$this->_storage_data  = $this->_accounts->get_option( $this->_type . '_data', [] );
	...
	private function get_products() {
		$products = $this->_accounts->get_option( $this->_plural_type, [] );
	...
	private function load_options() {
		...
		foreach ( $option_names as $option_name ) {
			$options[ $option_name ] = $this->_accounts->get_option( $option_name, [] );
		}
...
class FS_User_Garbage_Collector implements FS_I_Garbage_Collector {
	...
	private function get_user_has_install_map() {
		...
		foreach ( $this->_types as $product_type ) {
			...
			$installs = $this->_accounts->get_option( $option_name, [] );
