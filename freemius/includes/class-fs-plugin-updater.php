...
class FS_Plugin_Updater {
	...
	private function filters() {
		 ...
		 */
		// WP 2.9+
		add_action( "after_plugin_row_{$this->_fs->get_plugin_basename()}", [
			&$this,
		...
		if ( ! $this->_fs->has_any_active_valid_license() ) {
			...
			add_action( 'admin_footer', [ &$this, '_add_fs_allow_updater_and_dialog_request_param' ] );
		}
	...
	private function remove_transient_filters() {
		...
		remove_filter( 'pre_set_site_transient_update_themes', [
			&$this,
			'pre_set_site_transient_update_plugins_filter',
		] );
	}
